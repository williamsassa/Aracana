/* Product catalogue for ARACANA AI.
...
export const FRONT_PRODUCTS = PRODUCTS.filter((p) => !p.background);
export const BACKGROUND_PRODUCTS = PRODUCTS.filter((p) => p.background);
