/* Editorial content for Research, Solutions and Careers — English source of truth.
...
export type ResearchAxis = {
  ...
  abstract: string;
  points: string[];
  /** Short blurb used in the Header nav dropdown (distinct from the full abstract). */
  navBlurb: string;
};

export const RESEARCH_EN: ResearchAxis[] = [
  {
...
export const ABOUT_VALUES_EN: Value[] = [
  {
...
export const ROLES_EN: OpenRole[] = [
  {
